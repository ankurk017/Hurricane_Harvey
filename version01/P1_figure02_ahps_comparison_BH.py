...
#case = 'post'
case = 'BH 2020'
labels = {"WRF_PBL00":'No PBL', "WRF_PBL01":'YSU', "WRF_PBL02":'MYJ TKE', "WRF_PBL04":'EDMF QNSE', "WRF_PBL06":'MYNN', "pre":'2001', "post":'2017', "BH 2020":'BH 2020', "BH 2001":'BH 2001'}
...
home_2512 = f'/nas/rstor/akumar/USA/PhD/Objective01/Hurricane_Harvey/WRF_Harvey_V2/WRF_Simulations/WRF_FNL_2512/{case}/WRF/'
wrfoutfile = (sorted(glob.glob(home_2512 + f'/test/em_real/wrfout_d02_2017-*{int(date)-1}*')) + sorted(glob.glob(home_2512 + f'/test/em_real/wrfout_d02_2017-*{int(date)}*')))[12:12+25]


if case=='BH 2020':
 home_2512 = '/rgroup/stela/akumar/BH_Simulations/2020/WRF_452_BH/'
 wrfoutfile = (sorted(glob.glob(home_2512 + f'/test/em_real/wrfout_d02_2017-*{int(date)-1}*')) + sorted(glob.glob(home_2512 + f'/test/em_real/wrfout_d02_2017-*{int(date)}*')))[12:12+25]
...
#domain_bb = [-96.23, -94.43, 29.0, 30.46] # smaller domain
levels = np.array((10, 20, 30, 40, 50, 100, 150, 200, 250, 300, 400, 500, 600, 700, 800, 900))
levels = np.array((1, 10, 20, 30, 40, 50, 100, 150, 200, 250, 300, 400, 500, 600, 700, 800, 900))
