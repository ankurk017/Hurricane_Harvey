...
case = 'BH'
case = 'pre'
labels = {"WRF_PBL00":'No PBL', "WRF_PBL01":'YSU', "WRF_PBL02":'MYJ TKE', "WRF_PBL04":'EDMF QNSE', "WRF_PBL06":'MYNN', "BH":'BH', 'post':'post', 'pre':'pre'}
...
wrfoutfile = sorted(glob.glob(home_2512 + f'/test/em_real/wrfout_d02_2017-*{date}*'))

if case=='BH':
 home_2512 = '/nas/rstor/akumar/USA/PhD/WRF_Building_Heights/WRF_Simulations/WRF/'
 wrfoutfile = sorted(glob.glob(home_2512 + f'/test/em_real/wrfout_d02_2017-*{int(date)}*'))
