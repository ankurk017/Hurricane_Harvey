...
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl00),    "b-",    label="No PBL",)
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl01),    "r-",    label="YSU",)
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl02),    "g-",    label="MYJ TKE",)
...
axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl00,    "b-",    label="No PBL",)
axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl01,    "r-",    label="YSU",)
axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl02,    "g-",    label="MYJ TKE",)
