...
wrfoutfile_pre = sorted(glob.glob(home_2512 + f"/LULC_2001/WRFV4.5.2/test/em_real/wrfout_d02_2017-08-2*00"))[12:-23]
wrfoutfile_post = sorted(glob.glob(home_2512 + f"/LULC_2017/WRFV4.5.2/test/em_real/wrfout_d02_2017-08-2*00"))[12:-23]
...
plt.colorbar(pre_cont, ax=axs.ravel())
