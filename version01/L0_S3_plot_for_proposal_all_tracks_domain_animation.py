...
for index in range(len(harvey['lon'])):
    print(index)
    d2bb = harvey['lon'][index]-3, harvey['lon'][index] + \
        3, harvey['lat'][index]-3, harvey['lat'][index]+3
    d3bb = harvey['lon'][index]-2, harvey['lon'][index] + \
        2, harvey['lat'][index]-2, harvey['lat'][index]+2
