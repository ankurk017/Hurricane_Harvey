...
domain_bb = [-96.856, -94.32974, 28.927032, 30.926292]
skip_id = 7
...
output_dir = f"../figures/Ensemble/Rainfall_2512/3doms/{case[1:]}/"
image_files = []
years = (
    2001,
    2017,
    ...
    for pre_post_id in range(2):
       ...
       #     locator=ticker.LogLocator(),
        ...
        ax[pre_post_id].quiver(
            pre_post_uv[pre_post_id]["west_east"][::skip_id],
            pre_post_uv[pre_post_id]["south_north"][::skip_id],
            pre_post_uv[pre_post_id].sel(u_v="u")[::skip_id, ::skip_id] ,
            pre_post_uv[pre_post_id].sel(u_v="v")[::skip_id, ::skip_id],  units='x', scale=40, width=0.022, 
        )
