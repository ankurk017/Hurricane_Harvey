...
date = '27'
wrfoutfile_pre = sorted(glob.glob(home_2512 + f'/pre/WRF/test/em_real/wrfout_d02_2017-08-{date}*'))
wrfoutfile_post = sorted(glob.glob(home_2512 + f'/post/WRF//test/em_real/wrfout_d02_2017-08-{date}*'))
...
wrf_pbl01 = sorted(glob.glob(home + f'/WRF_case01/WRF_plus3/test/em_real/wrfout_d01_2017-08-{date}*'))
wrf_pbl02 = sorted(glob.glob(home + f'/WRF_case02/WRF_plus3/test/em_real/wrfout_d01_2017-08-{date}*'))
...
plt.tight_layout()
#plt.savefig(f'../figures_paper/rainfall_Houston_all_accumulated_difference_{date}_urban.jpeg')
#plt.show()
...
#plt.savefig(f'../figures_paper/rainfall_Houston_pre_post_boxplot_{date}_foreced_urabn.jpeg', dpi=300)
plt.show()
#plt.close()
