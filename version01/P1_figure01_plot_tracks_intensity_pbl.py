...
wrf_pbl00 = sorted(glob.glob(home + f'/WRF_PBL00//test/em_real/wrfout_d02_2017-*'))[::1]
wrf_pbl01 = sorted(glob.glob(home + f'/WRF_PBL01//test/em_real/wrfout_d02_2017-*'))[::1]
wrf_pbl02 = sorted(glob.glob(home + f'/WRF_PBL02//test/em_real/wrfout_d02_2017-*'))[::1]
wrf_pbl03 = sorted(glob.glob(home + f'/WRF_PBL04//test/em_real/wrfout_d02_2017-*'))[::1]
wrf_pbl06 = sorted(glob.glob(home + f'/WRF_PBL06//test/em_real/wrfout_d02_2017-*'))[::1]
...
out_pbl6 = src.wrf_track.get_track_details(wrf_pbl06)


out = (out_pbl2, out_pbl3, out_pbl4, out_pbl6)

lab = ['YSU', 'MYJ TKE', 'EDMF QNSE', 'MYNN']
col = ("b", 'r','g', 'm')
titles = 'PBL_MYNN'


intensity_ax = src.wrf_track.plot_track_intensity(harvey, out, labels=lab, colors=col)
plt.savefig('../figures_paper/pbl/MYNN_pbl_track_pre_post.jpeg', dpi=400)
...
plt.savefig('../figures_paper/pbl/MYNN_pbl_intensity_pre_post.jpeg', dpi=400)
