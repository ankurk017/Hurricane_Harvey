...
wrfoutfile_pbl00 = sorted(glob.glob(home + f'/WRF_FNL_post/WRF/test/em_real/wrfout_d02_2017-*'))
wrfoutfile_pbl01 = sorted(glob.glob(home + f'/WRF_FNL_2050/WRF/test/em_real/wrfout_d02_2017-*'))
wrfoutfile_pbl02 = sorted(glob.glob(home + f'/WRF_FNL_2100/WRF/test/em_real/wrfout_d02_2017-*'))
wrfoutfile_pbl04 = sorted(glob.glob(home + f'/WRF_FNL_2100/WRF/test/em_real/wrfout_d02_2017-*'))

wrfoutfile_pbl01_crop = sorted(glob.glob(home + f'/WRF_FNL_2050_cropland/WRF/test/em_real/wrfout_d02_2017-*'))
wrfoutfile_pbl02_crop = sorted(glob.glob(home + f'/WRF_FNL_2100_cropland/WRF/test/em_real/wrfout_d02_2017-*'))
...
var_timeseries_pbl00 = get_wrf_pcp(wrfoutfile_pbl00, location, box=box)
var_timeseries_pbl01 = get_wrf_pcp(wrfoutfile_pbl01, location, box=box)
var_timeseries_pbl02 = get_wrf_pcp(wrfoutfile_pbl02, location, box=box)

var_timeseries_pbl01_crop = get_wrf_pcp(wrfoutfile_pbl01_crop, location, box=box)
var_timeseries_pbl02_crop = get_wrf_pcp(wrfoutfile_pbl02_crop, location, box=box)
var_timeseries_pbl04 = get_wrf_pcp(wrfoutfile_pbl04, location, box=box)
...
gpm_index = np.where([gpm_timestep_values==datetime.datetime.utcfromtimestamp(var_timeseries_pbl04["Time"][0].values.astype('O') / 1e9) for gpm_timestep_values in gpm_timestep])[0][0]
#################
...
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl00),    "b-",    label="2017",)
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl01),    "r-",    label="2050",)
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl02),    "g-",    label="2100",)

axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl01_crop),    "r--",    label="2050 crop",)
axs.plot(var_timeseries_pbl04["Time"],  np.cumsum(var_timeseries_pbl02_crop),    "g-",    label="2100 crop",)
...
# plt.ylim((0, 510))
plt.tight_layout()
plt.savefig('../figures_paper/PBL_WRF_GPM_rainfall_accum_EPA_cropland.jpeg')
#plt.show()

fig, axs = plt.subplots(1, 1, figsize=(10, 5.5))
axs.plot(gpm_timestep, gpm_rainfall_region.values, "k-", label="GPM")

axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl00,    "b-",    label="2017",)
axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl01,    "r-",    label="2050",)
axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl02,    "g-",    label="2100",)
#axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl04,    "m-",    label="EDMF QNSE",)

axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl01_crop,    "r--",    label="2050 crop",)
axs.plot(var_timeseries_pbl04["Time"],  var_timeseries_pbl02_crop,    "g--",    label="2100 crop",)
...
# plt.ylim((0, 510))
plt.tight_layout()
#plt.savefig('../figures_paper/PBL_WRF_GPM_rainfall.jpeg')
#plt.show()
