...
wrfoutfile_pre = sorted(glob.glob('/nas/rgroup/stela/akumar/WRF_Harvey_v4/WRF_Simulations//LULC_2001/WRFV4.5.2/test/em_real/wrfout_d02_2017-08-27*'))
wrfoutfile_post = sorted(glob.glob('/nas/rgroup/stela/akumar/WRF_Harvey_v4/WRF_Simulations//LULC_2017/WRFV4.5.2/test/em_real/wrfout_d02_2017-08-27*'))
 ...
 gridspec_kw={'wspace': 0.4, })
    ...
    for pre_post_id in range(2):
        ...
        ax[pre_post_id].quiver(
            ...
            pre_post_uv[pre_post_id].sel(u_v="v")[::4, ::4],  units='x', scale=140, width=0.009, 
        )
...
#    plt.tight_layout()
    ...
    plt.savefig(f"../figures_draft01/Divergence/Houston_divergence_{str(slp.Time.values)[:13]}.jpeg", dpi=400, bbox_inches='tight')
    plt.close()
