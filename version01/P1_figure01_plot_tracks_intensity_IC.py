...
home = '/nas/rstor/akumar/USA/PhD/Objective01/Hurricane_Harvey/WRF_Harvey_V2/WRF_Simulations/IC/WRF_IC/'

wrf_pbl00 = sorted(glob.glob(home + f'/WRF_2017082200/test/em_real/wrfout_d01_2017-*'))[::5]
wrf_pbl01 = sorted(glob.glob(home + f'/WRF_2017082300/test/em_real/wrfout_d01_2017-*'))[::5]
wrf_pbl02 = sorted(glob.glob(home + f'/WRF_2017082400/test/em_real/wrfout_d01_2017-*'))[::5]
wrf_pbl03 = sorted(glob.glob(home + f'/WRF_2017082500/test/em_real/wrfout_d01_2017-*'))[::5]
