...
wrfoutfile = sorted(glob.glob(
    '/nas/rstor/akumar/USA/PhD/Objective01/Hurricane_Harvey/WRF_Harvey_V1/pre/WRF_9-3-51/WRFV4/wrfout_d01_2017-*27*'))
wrf_pcp_pre = (
...
wrf_pcp_pre = getvar(
    Dataset(wrfoutfile[-1]), "RAINC") + getvar(Dataset(wrfoutfile[-1]), "RAINNC")
...
cont = ax[1].contourf(wrf_lon, wrf_lat, wrf_pcp_post-wrf_pcp_pre,
                      cmap="bwr", levels=[-200, -150, -100, -50, 0, 50, 100, 150, 200])
