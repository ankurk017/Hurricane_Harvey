...
ax = axes[0]
var_timeseries_pre.plot(ax = ax, cmap='gist_ncar', levels=np.arange(10, 350, 20), extend='both', cbar_kwargs={'shrink':0.8})
...
ax = axes[1]
var_timeseries_post.plot(ax=ax, cmap='gist_ncar', levels=np.arange(10, 350, 20) , extend='both', cbar_kwargs={'shrink':0.8})
ax.set_xlim([start_lon, end_lon])
rect = Rectangle((start_lon, start_lat), end_lon - start_lon, end_lat - start_lat,
                 facecolor='none', edgecolor='red', linewidth=2)
ax.add_patch(rect)
...
ax = axes[2]
(var_timeseries_post-var_timeseries_pre).plot(ax=ax, cmap='bwr', levels=np.arange(-40, 50, 10), extend='both', cbar_kwargs={'shrink':0.8})
ax.set_xlim([start_lon, end_lon])
rect = Rectangle((start_lon, start_lat), end_lon - start_lon, end_lat - start_lat,
                 facecolor='none', edgecolor='red', linewidth=2)
ax.add_patch(rect)
