...
axs[1].set_ylabel(f'')
#plt.tight_layout()
plt.savefig('../figures_draft01/extended_fig04_pcp_rainband1_loc2_rainband34.jpeg', dpi=300, bbox_inches='tight')
...
# Save the figure
plt.savefig('../figures_draft01/extended_fig04_pcp_rainband2_loc2_rainband34.jpeg', dpi=300, bbox_inches='tight')
...
plt.savefig('../figures_draft01/extended_fig04_rainband_locs_loc2_rainband34.jpeg', dpi=300)
plt.show()
