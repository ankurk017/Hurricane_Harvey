...
wrfoutfile_2001 = get_wrffiles('/rgroup/stela/akumar/BH_Simulations/2000/WRF_452_BH/test/em_real/')
wrfoutfile_2017 = get_wrffiles('/rgroup/stela/akumar/BH_Simulations/2020/WRF_452_BH/test/em_real/')
wrfoutfile_2050 = get_wrffiles('/nas/rstor/akumar/USA/PhD//WRF_Building_Heights/WRF_Simulations/WRF_2050/WRF/test/em_real/')
wrfoutfile_2100 = get_wrffiles('/nas/rstor/akumar/USA/PhD//WRF_Building_Heights/WRF_Simulations/WRF_2100/WRF/test/em_real/')
...
plot_accp(wrfoutfile_2001, ahps_grid, plot_axis=cont_2001_ax, year_label='(c) BH LULC 2001')
plot_accp(wrfoutfile_2017, ahps_grid, plot_axis=cont_2017_ax, year_label='(d) BH LULC 2017')

plot_accp(wrfoutfile_2050, ahps_grid, plot_axis=cont_2050_ax, year_label='(e) BH LULC 2050')
cont = plot_accp(wrfoutfile_2100, ahps_grid, plot_axis=cont_2100_ax, year_label='(f) BH LULC 2100')
